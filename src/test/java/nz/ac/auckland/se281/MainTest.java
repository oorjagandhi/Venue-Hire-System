...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void T1_09_two_venues_saved() throws Exception {
    ...
    public void T2_19_make_booking_too_many_attendees() throws Exception {
      ...
      assertContains("Number of attendees adjusted from 400 to 260, as the venue capacity is 260.");
    ...
    @Test
    public void T2_22_next_available_date_whenn_system_date_moved_with_bookings() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
    ...
    public void T3_24_add_musicservice_booking_does_not_exist() throws Exception {
      ...
      assertContains(
          "Music service not added: there is no booking with reference 'abc' in the" + " system.");
      assertDoesNotContain("Successfully added", true);
    }
    ...
    public void T3_25_add_floral_service_booking_does_not_exist() throws Exception {
      ...
      assertContains(
          "Floral service not added: there is no booking with reference 'abc' in the" + " system.");
      assertDoesNotContain("Successfully added", true);
    }
